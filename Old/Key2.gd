...
func _process(_delta):
	if GameManager.key_item2 == true && GameManager.show2 == false:
		visible = true
		timer.start()
		GameManager.show2 = true
	...
	if GameManager.key_item2 == true && GameManager.key_item3 == false && GameManager.key_item1 == false && GameManager.show1_1 == false:
