...
func state_input(event : InputEvent):
	...
	if(event.is_action_pressed("switchc") && Global.can_skill == true && GameManager.skill_switch_state == 1 && GameManager.mana_player_one >= 40) && Global.talking == false && Global.dog == false:
		skill()
