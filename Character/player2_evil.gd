...
@onready var Projectile = preload("res://Objects/Black_hole.tscn")
var held_item = null
signal throw_item()
...
func handle_atk():
	...
	#x-ray vision for puzzle, maybe shows enemies weakness?
...
func _on_throw_item():
	if right == true:
		held_item = Projectile.instantiate()
		#held_item_position.add_child(held_item)
		held_item.position = (position - Vector2(-5,10))
